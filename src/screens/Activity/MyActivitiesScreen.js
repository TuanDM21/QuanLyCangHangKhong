...
const styles = StyleSheet.create({
  ...
  activityItem: { backgroundColor: "#fff", borderRadius: 14, padding: 16, marginBottom: 14, borderWidth: 1, borderColor: "#e0e7ef", shadowColor: "#007AFF", shadowOpacity: 0.06, shadowRadius: 2, elevation: 1 },
  activityToday: {
    borderColor: '#FF9500',
    borderWidth: 2,
